...
document.addEventListener("DOMContentLoaded", () => {
    ...
    .then(([idols, parsedData]) => {
        ...
        populateFilters();
        setupColorSearchAndFilters();
        renderColorTab();
    })
    .catch(err => {
        console.error("Error loading colors dashboard:", err);
    });
});
...
function populateFilters() {
    ...
    const groupSelect = document.getElementById("color-tab-group-filter");
    if (groupSelect) {
    ...
    const agencySelect = document.getElementById("color-tab-agency-filter");
    if (agencySelect) {
...
function setupColorSearchAndFilters() {
...
function renderColorTab() {
    ...
    // Check hash scroll (e.g. colors.html#Red)
